...
# Definir una función para calcular el promedio de temperaturas
def calcular_promedio(temperaturas):
    total_temp = sum(temperatura["temp"] for temperatura in temperaturas)
    return total_temp / len(temperaturas)


# Iterar a través de las ciudades
for ciudad_idx, ciudad in enumerate(temperaturas):
    ...
    for semana_idx, semana in enumerate(ciudad):
        ...
        print(f"Semana {semana_idx + 1}: Promedio de temperaturas = {promedio_semana:.2f}°C")

    print()  # Agregar una línea en blanco entre ciudades